...
// Custom IndexedDB storage for performance (non-blocking, unlimited size)
...
// Attachment interface for non-image files
...
export interface Message {
 ...
 attachments?: Attachment[]; // Non-image attachments
 tool_calls?: any[];
 tool_call_id?: string;
 tool_name?: string;
 timestamp: number;
...
export type CurrentView = 'chat' | 'library' | 'files';
